...
export const BasketPage = () => {
   ...
   return (
       <div className="currentBasketPageContainer">
            {isEditing ? <Input addonBefore={<div style={{color: 'white'}}>Введите новое название:</div>} 
                defaultValue={`${basket?.basket_name}`} 
                style={{width: '80%', margin: '2%'}}/> : <h1>{basket?.basket_name}</h1>}
